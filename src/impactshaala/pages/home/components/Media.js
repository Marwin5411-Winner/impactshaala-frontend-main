...
function Media({
  ...
  const handleLike = async (reactionType) => {
    const resp = await likeMediaPost(post._id, reactionType);
    if (resp.errRes) {
      if (resp.errRes.data) {
  ...
  return (
    <Col sm={12}>
        ...
        <Card.Body>
            ...
            <div className="d-flex justify-content-between">
              ...
              <div className="w-100">
                <div className="d-flex justify-content-between">
                  <div
                    onClick={() =>
                      navigate("/profile-details/" + post.userId._id)
                    }
                      ...
                      <Dropdown.Menu className="dropdown-menu m-0 p-0">
                        ...
                        {user && user._id === post.userId._id && (
                          <Dropdown.Item
                            className=" p-3"
                            onClick={() =>
                              navigate("/posts/edit-media-post", {
                                state: post,
                              })
                            }
                          >
          ...
          <div className="comment-area mt-3">
            <div className="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div className="d-flex align-items-center">
                  <div className="like-data">
                    <div className="d-flex align-items-start">
                      {/* These component have to change */}
                      <LikeComponent
                  ...
                  <div className="total-like-block ms-2 me-3">
                    <LikeModal likes={post.reactions} />
                  </div>
                  <div
              ...
              {/* <ShareOffcanvas /> */}
              <SavePost
                isSaved={user.savedMediaPosts.includes(post._id)}
            ...
            <ul className="post-comments list-inline p-0 m-0">
              {post.comments &&
                post.comments.slice(0, commentNumber).map((comment, index) => {
      ...
      <ConfirmationPopup
        ...
        show={showPopup}
        handleSuccess={() => handleDelete(post._id)}
