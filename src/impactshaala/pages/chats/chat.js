                                                            ...
                                                            <div className="chat-header-icons d-flex">
                                                                ...
                                                                <Dropdown className="bg-soft-primary d-flex justify-content-center align-items-center" as="span">
                                                                    ...
                                                                    <Dropdown.Menu className="dropdown-menu-right">
                                                                        ...
                                                                        <Dropdown.Item className="d-flex align-items-center" href="#"><i className="material-symbols-outlined md-18 me-1">watch_later</i>Report</Dropdown.Item>
